...
async function selectCity(page, reporter) {
...
async function selectKPI(page, reporter) {
  const startTime = Date.now();
...
async function applyKPIAndVerify(page, reporter) {
  const startTime = Date.now();
